...
1. Vérifiez que le bug n'a pas déjà été signalé dans les [Issues](https://github.com/yoanbernabeu/daplos-bundle/issues)
...
Utilisez des messages de commit clairs selon la convention [Conventional Commits](https://www.conventionalcommits.org/) :
